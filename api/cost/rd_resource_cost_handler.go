...
// RadixDeploymenyResourceCostHandler Instance variables
type RadixDeploymenyResourceCostHandler struct {
...
// NewRadixDeploymenyResourceCostHandler Constructor
func NewRadixDeploymenyResourceCostHandler(repo models.CostRepository, accounts models.Accounts, radixapi radix_api.RadixAPIClient, env *models.Env) RadixDeploymenyResourceCostHandler {
	return RadixDeploymenyResourceCostHandler{
		repo:     repo,
		env:      *env,
		accounts: accounts,
		radixapi: radixapi,
...
func (costHandler *RadixDeploymenyResourceCostHandler) getToken() string {
	return costHandler.accounts.GetToken()
}

// GetTotalCost handler for GetTotalCost
func (costHandler *RadixDeploymenyResourceCostHandler) GetTotalCost(fromTime, toTime *time.Time, appName *string) (*costModels.ApplicationCostSet, error) {
...
func (costHandler *RadixDeploymenyResourceCostHandler) GetFutureCost(appName string) (*costModels.ApplicationCost, error) {
...
func (costHandler *RadixDeploymenyResourceCostHandler) filterApplicationCostsBy(appName *string, cost *costModels.ApplicationCostSet) []costModels.ApplicationCost {
...
func (costHandler *RadixDeploymenyResourceCostHandler) filterApplicationsByAccess(rrMap map[string]*radix_api.RadixApplicationDetails, applicationCosts []costModels.ApplicationCost) []costModels.ApplicationCost {
...
func (costHandler *RadixDeploymenyResourceCostHandler) getRadixRegistrationMap(appName *string) (*map[string]*radix_api.RadixApplicationDetails, error) {
...
func (costHandler *RadixDeploymenyResourceCostHandler) getRadixApplicationDetails(appName string) (*radix_api.RadixApplicationDetails, error) {
