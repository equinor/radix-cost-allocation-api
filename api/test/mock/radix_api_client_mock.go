...
func (mr *MockRadixAPIClientMockRecorder) GetRadixApplicationDetails(appParams, token any) *gomock.Call {
...
func (mr *MockRadixAPIClientMockRecorder) ShowRadixApplications(appParams, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
