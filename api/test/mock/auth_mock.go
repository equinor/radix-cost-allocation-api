...
// Source: ./api/utils/auth_provider.go
...
import (
	...
	utils "github.com/equinor/radix-cost-allocation-api/api/utils"
...
func (m *MockAuthProvider) VerifyToken(ctx context.Context, token string) (utils.IDToken, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyToken", ctx, token)
	ret0, _ := ret[0].(utils.IDToken)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
