...
// bindParamChangeComponentSecret binds the parameter Impersonate-Group
func (o *ChangeComponentSecretParams) bindParamImpersonateGroup(formats strfmt.Registry) []string {
