...
func (o *GetBatchesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetBatchesOK) Error() string {
	...
	return fmt.Sprintf("[GET /applications/{appName}/environments/{envName}/jobcomponents/{jobComponentName}/batches][%d] getBatchesOK %s", 200, payload)
}
