...
// bindParamTriggerPipelineDeploy binds the parameter Impersonate-Group
func (o *TriggerPipelineDeployParams) bindParamImpersonateGroup(formats strfmt.Registry) []string {
