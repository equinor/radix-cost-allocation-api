...
// bindParamUpdatePrivateImageHubsSecretValue binds the parameter Impersonate-Group
func (o *UpdatePrivateImageHubsSecretValueParams) bindParamImpersonateGroup(formats strfmt.Registry) []string {
