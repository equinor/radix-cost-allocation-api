...
// bindParamRegenerateDeployKey binds the parameter Impersonate-Group
func (o *RegenerateDeployKeyParams) bindParamImpersonateGroup(formats strfmt.Registry) []string {
